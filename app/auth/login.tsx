        ...
        <SafeAreaView style={styles.body}>
            <KeyboardAvoidingView
              ...
              <ScrollView>
               ...
               <SafeAreaView>
                <Text style={styles.firstT}> LOGIN </Text>
               </SafeAreaView>
               ...
               <View>
                  ...
                  <TouchableOpacity onPress={() => router.push('/protected/home')} style={styles.sign}>
                    <Text style={styles.secondt}> Login </Text>  
                    <AntDesign name="login" size={24} color="black" />
                  </TouchableOpacity>    

                  <View  style={styles.view}>
                  <Text style={styles.thirdt}>Dont have an account? </Text> 
                   <TouchableOpacity onPress={() => router.push('/auth/signup')}>
                    <Text  style={styles.fourtht}>Sign up</Text>
                   </TouchableOpacity>
                  </View>            
               </View>
              </ScrollView>
